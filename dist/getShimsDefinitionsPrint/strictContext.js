...
exports.default = (function (constants) { return [
    ts.createTypeAliasDeclaration(undefined, undefined, ts.createIdentifier(constants.STRICT_CONTEXT), [
        ...
        ts.createPropertySignature(undefined, ts.createIdentifier("commit"), undefined, ts.createTypeReferenceNode(ts.createIdentifier(constants.STRICT_COMMIT), [ts.createTypeReferenceNode(ts.createIdentifier("M"), undefined)]), undefined),
        ts.createPropertySignature(undefined, ts.createIdentifier("dispatch"), undefined, ts.createTypeReferenceNode(ts.createIdentifier(constants.STRICT_DISPATCH), [ts.createTypeReferenceNode(ts.createIdentifier("A"), undefined)]), undefined)
    ]))
]; });
