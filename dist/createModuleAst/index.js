...
exports.createModuleAst = function (sourceFile, fileInfo, constants) { return [
    ...
    declareModule_1.declareModule(constants.VUEX, [
        ...
        createFlatInterfaceDeclaration_1.createFlatInterfaceDeclaration(sourceFile, fileInfo, constants.LOCAL_GETTERS, constants.RETURN_TYPE, constants.GETTERS, constants),
        createFlatInterfaceDeclaration_1.createFlatInterfaceDeclaration(sourceFile, fileInfo, constants.LOCAL_MUTATION_TYPES, constants.ARGUMENT_2, constants.MUTATIONS, constants),
        createFlatInterfaceDeclaration_1.createFlatInterfaceDeclaration(sourceFile, fileInfo, constants.LOCAL_ACTION_TYPES, constants.ARGUMENT_2, constants.ACTIONS, constants),
        createLiteralAliasDeclaration_1.createLiteralAliasDeclaration(sourceFile, fileInfo, constants.ROOT_GETTERS, constants.LOCAL_GETTERS, constants.GETTERS),
        createLiteralAliasDeclaration_1.createLiteralAliasDeclaration(sourceFile, fileInfo, constants.MUTATION_TYPES, constants.LOCAL_MUTATION_TYPES, constants.MUTATIONS),
        createLiteralAliasDeclaration_1.createLiteralAliasDeclaration(sourceFile, fileInfo, constants.ACTION_TYPES, constants.LOCAL_ACTION_TYPES, constants.ACTIONS),
